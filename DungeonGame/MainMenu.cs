...
namespace DungeonGame
{
      class MainMenu 
    {
        static void Main(string[] args)
        {
            ...
            String Answer,HelpAnswer = " ",RaceName = "",Invalid = "Y";


            Console.WriteLine("Hello and Welcome to Eau Minerelle Natturelle!");
            Console.WriteLine(" ");

            Console.WriteLine("Do you wish to read the on screen help?(Y/N)");
            HelpAnswer = Console.ReadLine().ToUpper();
            ...
            if (HelpAnswer == "N")
            {
                ...
                Console.WriteLine("You chose not to use the screen help, therefore it won't be provided");
                Console.ReadLine();
            }
